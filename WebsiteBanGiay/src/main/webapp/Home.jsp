...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    <img style="height:55px; width:64px; margin: auto;" src="https://baobihuuco.com/wp-content/uploads/2019/04/icon-giao-hang-toan-quoc.jpg">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://baobihuuco.com/wp-content/uploads/2019/04/icon-thanh-toan-cod.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://www.kimbaowabe.com/image/catalog/Homepage/unnamed.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://organicjsc.com/wp-content/uploads/2020/12/Icon-Doi-Tra-Hang.jpg" alt="Card image cap">
    <div class="card-body">
